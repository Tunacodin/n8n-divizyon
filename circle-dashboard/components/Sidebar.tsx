...
const navigation: NavEntry[] = [
  ...
  },
  {
    ...
    icon: icons.pipeline,
    items: [
      { label: 'Basvurular', href: '/basvuru-formu', badge: 'dot', badgeColor: 'bg-blue-400' },
      { label: 'Kontrol', href: '/kontrol', badge: 'dot', badgeColor: 'bg-yellow-400' },
      { label: 'Kesin Kabul', href: '/kesin-kabul', badge: 'dot', badgeColor: 'bg-emerald-400' },
      { label: 'Kesin Ret', href: '/kesin-ret', badge: 'dot', badgeColor: 'bg-red-400' },
    ],
  },
  {
    id: 'members',
    ...
    icon: icons.users,
    items: [
      { label: 'Nihai Olmayan', href: '/nihai-olmayan', badge: 'dot', badgeColor: 'bg-purple-400' },
      { label: 'Oryantasyon', href: '/oryantasyon', badge: 'dot', badgeColor: 'bg-violet-400' },
      { label: 'Nihai Ag Uyesi', href: '/nihai-ag-uyesi', badge: 'dot', badgeColor: 'bg-amber-400' },
      { label: 'Deaktive', href: '/deaktive', badge: 'dot', badgeColor: 'bg-gray-400' },
      { label: 'Circle Uyeleri', href: '/members', badge: 'dot', badgeColor: 'bg-cyan-400' },
    ],
  },
  {
    id: 'events',
    label: 'Etkinlikler',
    href: '/etkinlikten-gelenler',
    icon: icons.calendar,
  },
  {
    id: 'analytics',
  ...
  },
  {
    ...
    icon: icons.settings,
    items: [
      { label: 'n8n Workflows', href: '/workflow' },
